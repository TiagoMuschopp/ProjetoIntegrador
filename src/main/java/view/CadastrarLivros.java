 ...
 * @author tiago
 */
public class CadastrarLivros extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Ano da publicação");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        anoPublicacao = jTextField5.getText();
        genero = jTextField6.getText();
        paginas = jTextField7.getText();
        
        controller.Cadastro.cadastrarLivro(titulo, isbn, autor, editora, anoPublicacao, genero, paginas);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(this); // Obtém o JFrame pai do componente atual
    frame.dispose(); // Fecha a janela
      ...
      java.awt.EventQueue.invokeLater(() -> {
            ...
            frame.setUndecorated(true); // Remove a barra de título
            frame.getContentPane().add(new CadastrarLivros());
            frame.pack();
